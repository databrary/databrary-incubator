...
public class DownloadManager extends BorderPane {
    ...
    public DownloadManager(final SlotTree st) {
        ...
        startButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String[] urls = new String[numFiles];
                String[] fileOutputs = new String[numFiles];

                System.out.println("-------------------------------the shakir sizeurl " + numFiles);
                ...
                for (int i = 0; i < st.size; i++) {
                    if (st.isleaf[i]) {   //checkTreeView.getItemBooleanProperty(i).get()
                        String u = UrlUtils.urlBase + "slot/" + st.slotId + "/asset/" + st.assetId[i] + "/download";
                        System.out.println("uuuuuuuuuuuuuuuuuuuuuu  =  " + u);

                        //String f = getDir() + File.separator + st.fileN[i].trim();   remove ':' char from file name
                          String f = getDir() + File.separator + UrlUtils.remove(st.fileN[i].trim(), ':');
                        
                        System.out.println("fffffffffffffffffffff  =  " + f);
                        urls[i] = u;

                        System.out.println("aaaaaaaaaaaaaaaaaaaaaaaa  =  " + urls);
                       fileOutputs[i] = f;  
                ...
                System.out.println("numFiles = " + numFiles);
                copyWorker = createWorker(numFiles, urls, fileOutputs);
    ...
    private Task<Boolean> createWorker(final int numFiles, String[] urls, String[] fileName) {
        return new Task<Boolean>() {

            @Override
            protected Boolean call() throws Exception {
                for (int i = 0; i < numFiles; i++) {  //start loop
                    if (!urls[i].equals("")) {
                        ...
                        try {
                            ...
                            while (true) {
                                ...
                                System.out.println("22222222222222 = " + i);
                                ...
                                System.out.println("33333333333333333333 = " + i);
                                ...
                                System.out.println("44444444444444444444444444444 = " + i);
                                ...
                                System.out.println("5555555555555555555555555555 = " + i);
                                ...
                                System.out.println("6666666666666666666666666666 = " + i);
                                System.out.println("Remaining size: " + remainingSize);
                                FileOutputStream fos = new FileOutputStream(file, true);

                                System.out.println("77777777777777777777777777777777 = " + i);
                                ...
                                System.out.println("8888888888888888888888888 = " + i);
                                ...
                                System.out.println("9999999999999999999999999999999 = " + i);
                                ...
                                while (remainingSize > 0) {
                                    ...
                                    updateMessage(transferedSize / (1024 * 1024) + " " + "MB received " + fileName[i]);
                                ...
                                System.out.println("1010101010101010100101 = " + i);
